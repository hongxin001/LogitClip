...
parser.add_argument('--noise_type', type=str, help='[clean, symmetric, asymmetric, dependent, open]', default='clean')
...
train_data, num_classes = build_dataset(args.dataset, args.noise_type, args.noise_rate, mode="train")

test_data, _ = build_dataset(args.dataset, "clean", 0, mode="test")
...
if args.exp_name:
    path = args.dataset + "_" + args.noise_type + "_" + str(args.noise_rate).replace('.', '')  + '_' + args.model + '_' + args.exp_name + '_' + args.alg
else:
    path = args.dataset + "_" + args.noise_type + "_" + str(args.noise_rate).replace('.', '') + '_' + args.model + '_' + args.alg
